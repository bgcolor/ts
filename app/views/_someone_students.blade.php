<?php 
if (true == $user['has_students']) {
?>
<div class="am-cf am-padding">
  <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">{{ $user['name'] }}的学徒</strong> / <small>My Students</small></div>
</div>
...
<div class="am-panel am-panel-default am-margin-horizontal">
  <div class="am-panel-bd">
    <div class="user-info">
      <h3><a href="javascript:;" class="user-link user-link" data-id="{{ $s->id }}">{{ $s->name }}</a>的进度</h3>
      <?php
